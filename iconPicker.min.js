...
var iconPickers=document.querySelectorAll('[data-action="iconPicker"]'),iconPickerOptions={};iconPickers&&iconPickers.forEach(function(a){a.dataset.iconPicker||(a.dataset.iconPicker=new IconPicker(a,iconPickerOptions))});
